...
namespace MovieApp.DataAccess
{
    public class MovieDataAccessLayer : IMovie
    {
        ...
        public async Task<List<Movie>> GetSimilarMovies(int movieId)
        {
            ...
            //Movie? movie = await _dbContext.Movies.FirstOrDefaultAsync(e => e.MovieId == movieId);
        ...
        async Task<Movie?> GetMovieData(int movieId)
        {
            try
            {
                Movie? movie = await _dbContext.Movies.FirstOrDefaultAsync(e => e.MovieId == movieId); //Fix this
                //To this await _dbContext.Movies.FirstOrDefaultAsync(e => e.MovieId == movieId)
